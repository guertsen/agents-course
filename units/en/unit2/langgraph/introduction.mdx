...
### 1️⃣ [What is LangGraph, and when to use it?](./when_to_use_langgraph.mdx)
### 2️⃣ [Building Blocks of LangGraph](./building_blocks.mdx)
### 3️⃣ [Alfred, the mail sorting butler](./first_graph.mdx)
### 4️⃣ [Alfred, the document Analyst agent](./document_analysis_agent.mdx)
### 5️⃣ [Quiz](./quiz1.mdx)
