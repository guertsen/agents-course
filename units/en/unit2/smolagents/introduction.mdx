...
### 1️⃣ [Why Use smolagents](./why_use_smolagents.mdx)
...
### 2️⃣ [CodeAgents](./code_agents.mdx)
...
### 3️⃣ [ToolCallingAgents](./tool_calling_agents.mdx)
...
### 5️⃣ [Retrieval Agents](./retrieval_agents.mdx)
...
### 6️⃣ [Multi-Agent Systems](./multi_agent_systems.mdx)
...
### 7️⃣ [Vision and Browser agents](./vision_agents.mdx)
